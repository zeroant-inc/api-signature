...
module.exports = {
  ...
  /**
   * @class MissingRequiredSignatureHeadersError
   * @public
   * @extends BaseError
   */
   MissingRequiredSignatureHeadersError: class MissingRequiredSignatureParamsError extends BaseError {
    /**
     * @param {Array} params The signature header's names
     */
    constructor(...params) {
      const message = `Missing required signature headers : ${params.join(', ')}.`;
      super(400, message);
    }
  },
